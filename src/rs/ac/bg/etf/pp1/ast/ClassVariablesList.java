...
public class ClassVariablesList extends ClassVarDeclList {

    private ClassVarDeclList ClassVarDeclList;
    private ClassVarDecl ClassVarDecl;

    public ClassVariablesList (ClassVarDeclList ClassVarDeclList, ClassVarDecl ClassVarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassVariablesList(\n");
