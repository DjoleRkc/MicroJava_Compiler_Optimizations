...
public class ConditionFactorsList extends CondFactList {

    private CondFact CondFact;
    private CondFactList CondFactList;

    public ConditionFactorsList (CondFact CondFact, CondFactList CondFactList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConditionFactorsList(\n");
