...
public class FormalParamsList extends FormalParametersList {
    ...
    public FormalParamsList (Type Type, String paramName, ArraySpecifier ArraySpecifier, FormalParametersList FormalParametersList) {
        this.Type=Type;
